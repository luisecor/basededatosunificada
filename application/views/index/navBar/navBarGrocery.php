<nav class="navbar navbar-expand-lg navbar-bg">
    <div class="container">
        <a class="navbar-brand titulo" href="<?=site_url('ingreso')?>">

<strong>SuperBase</strong>
</a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link  table-link" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <div>
                            <img src="<?=base_url?>css/png/Menu.png" alt="Icono de base de datos" class="mx-1 navicon">
                        </div>
                    ...
                    <a class="nav-link import-container" href="#" id="navbarDropdown" role="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="<?=base_url?>css/png/Agregar.png" alt="Icono de base de datos" class="mx-1 navicon">
                            <path
                                d="M6.99107 6.99107V0H11.0089V6.99107H18V11.0089H11.0089V18H6.99107V11.0089H0V6.99107H6.99107Z"
                                fill="white" />
                        </svg>
                ...
                <li class="nav-item dropdown justify-content-end">
                    <a class="nav-link " href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <img src="<?=base_url?>css/png/Ajustes.png" alt="Icono de base de datos" class="mx-1 navicon">
                    ...
                    <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href='<?=site_url('analiticas/dashboard')?>'>Analíticas</a></li>
                        <?php } ?>
                    </ul>
                    ...
                    <a class="nav-link " href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <img src="<?=base_url?>css/png/informacion.png" alt="Icono de base de datos" class="mx-1 navicon">
                        </a>
                        <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
