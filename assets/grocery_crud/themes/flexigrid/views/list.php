            ...
            <tr class='hDiv'>
                ...
                <th width='<?php echo $column_width?>%'>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu z-index 1000">
                ...
                <td align="left" width='20%'>
                    <div class='tools d-flex justify-content-center'>
                        ...
                        <a href='<?php echo $row->edit_url?>'
                            title='<?php echo $this->l('list_edit')?> <?php echo $subject?>' class="edit_button"><span
					...
					?>
                        <a href="<?php echo $action_url; ?>" class="<?php echo $action->css_class; ?> crud-action"
