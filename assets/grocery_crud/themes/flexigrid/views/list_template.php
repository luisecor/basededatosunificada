    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
					...
					foreach ($filtros as $filtro) {
						...
						if ($filtro_busqueda!=null and in_array($filtro['id'],$filtro_busqueda['filtro'] ))
							$cheked =  "checked='true'";
      ...
      <div class="modal-footer">
						...
						<div class="p-1">
							...
							<button type="button" class="cancel-btn" data-bs-dismiss="modal">Cerrar</button>
                        </div>
                    </form>
      </div>
    </div>
...
//Cambiar aca luego en el servidor 
// SERVIDOR ---> 
const win = window.location.origin + "/index.php";
